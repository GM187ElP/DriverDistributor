...
{
    private static ServiceProvider CreateServices(SqlConnectionStringBuilder connectionString)
    {
    ...
    public static void RunAdo(OleDbConnectionStringBuilder connectionString, DbType dbType)
    {
        AdoMigration.CreateTable(connectionString.ToString(), dbType);
    }

    private static void EnsureCreateDatabase(SqlConnectionStringBuilder connectionString)
    {
